...
public class NybCParser extends Parser {
	...
	public static final int
		...
		STRING=40, BOOL=41, LINE_COMMENT=42, WS=43;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, "IDENT", "INT", "FLOAT", "STRING", "BOOL", "LINE_COMMENT", "WS"
		};
	}
	...
	public final ProgramListContext programList() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 137453633668L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CallFuncParaContext callFuncPara() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4329327034384L) != 0)) {
				{
				setState(288);
				expression(0);
				setState(293);
